    ...
    while fin != 1:
        for event in pygame.event.get():
            ...
            if (event.type == pygame.KEYDOWN and (
                    event.key == pygame.K_LEFT or event.key == pygame.K_RIGHT)) or event.type == pygame.QUIT:
                bottomright = None
                topleft = None
...
if __name__ == "__main__":
    ...
    while 1:
        ...
        if os.path.isfile(f):
            ...
            im.save(os.path.join(output_dir, append_suffix(filename)))
